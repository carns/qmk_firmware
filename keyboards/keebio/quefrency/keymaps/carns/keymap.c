...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    KC_DEL,   KC_ESC,   KC_GRAVE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,  KC_BSPC, KC_HOME,
    ...
    KC_F7,   KC_F8,  MO(_FN1), KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,           MO(_FN1),KC_SPC,  KC_RALT, KC_PRINT_SCREEN, KC_PRINT_SCREEN, KC_LEFT, KC_DOWN, KC_RGHT
  ),
